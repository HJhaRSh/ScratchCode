      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-8 overflow-y-auto space-y-8 max-w-4xl">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6">
            <div className="h-20 w-20 rounded-full bg-gradient-to-r from-emerald-400 to-cyan-500 flex items-center justify-center text-3xl font-extrabold text-slate-950 uppercase shadow-lg shadow-emerald-500/10">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {mockUser.badges.map((b) => (
                <div key={b.slug} className="bg-slate-900 border border-slate-800 rounded-xl p-5 flex flex-col items-center justify-center text-center space-y-2 group hover:border-slate-700 transition-colors">
